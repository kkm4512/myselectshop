...
class ProductServiceTest {
    ...
    void test1() {
        // given
        Long productId = 100L;
        int myprice = MIN_MY_PRICE + 3_000_000;
        ...
        ProductService productService = new ProductService(productRepository, folderRepository, productFolderRepository, userRepository);
    ...
    void test2() {
        ...
        // then
        assertEquals (
                "유효하지않은 관심 가격 입니다 최소 " + MIN_MY_PRICE + "원 이상 입니다",
